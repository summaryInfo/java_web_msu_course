...
public class ConsumerPageTest {
  private WebDriver driver;

  @BeforeClass
  public void setUp() {
    driver = new FirefoxDriver();
    //driver.get("http://127.0.0.1:8080/app/consumer");
    driver.get("http://192.168.1.39:8080/app/consumer");
  ...
  public void doTest() {
    ...
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-101+label span:nth-child(2)")).getText(), "A potato consumer");
    ...
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-101+label span:nth-child(5)")).getText(), "4(444)444-44-44");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-101+label span:nth-child(6)")).getText(), "ilove@potates.com");
    ...
    driver.findElement(By.id("query_name")).sendKeys("A po%");
    driver.findElement(By.id("query_phone")).clear();
    driver.findElement(By.id("query_phone")).sendKeys("4(444)444-44-44");
    driver.findElement(By.id("query_email")).clear();
    driver.findElement(By.id("query_email")).sendKeys("ilove@potates.com");
    driver.findElement(By.id("query_query")).click();
    ...
    Assert.assertEquals(driver.findElements(By.cssSelector(".collapsible-content")).size(), 2);
