...
public class SupplyPageTest {
  private WebDriver driver;

  @BeforeClass
  public void setUp() {
    driver = new FirefoxDriver();
    //driver.get("http://127.0.0.1:8080/app/supply");
    driver.get("http://192.168.1.39:8080/app/supply");
  ...
  public void doTest() {
    ...
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-101+label span:nth-child(4)")).getText(), "20.0");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-101+label span:nth-child(5)")).getText(), "2020-12-21 00:00:00");
    ...
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-102+label span:nth-child(4)")).getText(), "10.0");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-102+label span:nth-child(5)")).getText(), "2020-11-21 00:00:00");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-102+label span:nth-child(6)")).getText(), "true");
    ...
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-103+label span:nth-child(3)")).getText(), "102");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-103+label span:nth-child(4)")).getText(), "10.0");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-103+label span:nth-child(5)")).getText(), "2021-01-13 00:00:00");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-103+label span:nth-child(6)")).getText(), "true");

    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-104+label span:nth-child(1)")).getText(), "104");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-104+label span:nth-child(2)")).getText(), "102");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-104+label span:nth-child(3)")).getText(), "103");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-104+label span:nth-child(4)")).getText(), "10.0");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-104+label span:nth-child(5)")).getText(), "2021-02-12 00:00:00");
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-104+label span:nth-child(6)")).getText(), "true");
    ...
    driver.findElement(By.id("query_provider")).clear();
    driver.findElement(By.id("query_provider")).sendKeys("101");
    ...
    driver.findElement(By.id("query_amount")).sendKeys("19.0");
    driver.findElement(By.id("query_amounthi")).clear();
    driver.findElement(By.id("query_amounthi")).sendKeys("21.0");
    driver.findElement(By.id("query_time")).clear();
    driver.findElement(By.id("query_time")).sendKeys("2020-12-20 00:00:00");
    driver.findElement(By.id("query_timehi")).clear();
    driver.findElement(By.id("query_timehi")).sendKeys("2020-12-22 00:00:00");
    ...
    Assert.assertEquals(driver.findElement(By.cssSelector("#collapsible-" + newid +" + label span:nth-of-type(2)")).getText(), "102");
    ...
    Assert.assertEquals(driver.findElements(By.cssSelector(".collapsible-content")).size(), 8);
